 ...
 * Copyright 2011-2021 The Bootstrap Authors (https://github.com/twbs/graphs/contributors)
...
(function (global, factory) {
  ...
  /**
   * --------------------------------------------------------------------------
   * Bootstrap (v5.0.0-beta2): utilindex.js
   * Licensed under MIT (https://github.com/twbs/blob/main/LICENSE)
   * --------------------------------------------------------------------------
   */
  var MAX_UID = 1000000;
  ...
  var getSelector = function getSelector(element) {
    ...
    if (!selector || selector === "#") {
      ...
      // See https://github.com/twbs/issues/32273
  ...
  var Carousel = /*#__PURE__*/ (function (_BaseComponent) {
    ...
    _proto._setActiveIndicatorElement = function _setActiveIndicatorElement(
      ...
      if (this._indicatorsElement) {
        var activeIndicator = SelectorEngine.findOne(
          SELECTOR_ACTIVE,
    ...
    _proto._slide = function _slide(direction, element) {
      ...
      var directionalClassName =
        direction === DIRECTION_NEXT ? CLASS_NAME_START : CLASS_NAME_END;
      var orderClassName =
        direction === DIRECTION_NEXT ? CLASS_NAME_NEXT : CLASS_NAME_PREV;
      var eventDirectionName =
        direction === DIRECTION_NEXT ? DIRECTION_LEFT : DIRECTION_RIGHT;
  ...
  var Collapse = /*#__PURE__*/ (function (_BaseComponent) {
    ...
    function Collapse(element, config) {
      ...
      for (var i = 0, len = toggleList.length; i < len; i++) {
        ...
        var filterElement = SelectorEngine.find(selector).filter(function (
          foundElem
        ) {
    ...
    _proto.show = function show() {
      ...
      if (
        ...
        this._element.classList.contains(CLASS_NAME_SHOW$1)
      ) {
        return;
      }
        ...
        actives = SelectorEngine.find(SELECTOR_ACTIVES, this._parent).filter(
          function (elem) {
            if (typeof _this2._config.parent === "string") {
              return (
                elem.getAttribute("data-bs-parent") === _this2._config.parent
              );
            }
  ...
  function mergePaddingObject(paddingObject) {
    return Object.assign(
      Object.assign({}, getFreshSideObject()),
      paddingObject
    );
  }
  ...
  */
  ...
  var Dropdown = /*#__PURE__*/ (function (_BaseComponent) {
    ...
    _proto.show = function show() {
      if (
        this._element.disabled ||
        this._element.classList.contains(CLASS_NAME_DISABLED) ||
        this._menu.classList.contains(CLASS_NAME_SHOW$2)
      ) {
        return;
      }
    ...
    Dropdown.dataApiKeydownHandler = function dataApiKeydownHandler(event) {
      ...
      if (
        ...
        var _button = this.matches(SELECTOR_DATA_TOGGLE$2)
          ? this
          : SelectorEngine.prev(this, SELECTOR_DATA_TOGGLE$2)[0];
      ...
      var items = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, parent).filter(
        isVisible
      );
  ...
  var Modal = /*#__PURE__*/ (function (_BaseComponent) {
    ...
    _proto._showBackdrop = function _showBackdrop(callback) {
      ...
      var animate = this._element.classList.contains(CLASS_NAME_FADE$1)
        ? CLASS_NAME_FADE$1
        : "";
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        var backdropTransitionDuration = getTransitionDurationFromElement(
          this._backdrop
        );
        ...
        if (this._element.classList.contains(CLASS_NAME_FADE$1)) {
          var _backdropTransitionDuration = getTransitionDurationFromElement(
            this._backdrop
          );
    ...
    _proto._setElementAttributes = function _setElementAttributes(
      selector,
      styleProp,
      callback
    ) {
    ...
    _proto._resetElementAttributes = function _resetElementAttributes(
      selector,
      styleProp
    ) {
      SelectorEngine.find(selector).forEach(function (element) {
  ...
  var Tooltip = /*#__PURE__*/ (function (_BaseComponent) {
    ...
    _proto._enter = function _enter(event, context) {
      ...
      if (
        context.getTipElement().classList.contains(CLASS_NAME_SHOW$4) ||
  ...
  var ScrollSpy = /*#__PURE__*/ (function (_BaseComponent) {
    ...
    _proto._activate = function _activate(target) {
      ...
      if (link.classList.contains(CLASS_NAME_DROPDOWN_ITEM)) {
        ...
        link.classList.add(CLASS_NAME_ACTIVE$2);
        SelectorEngine.parents(link, SELECTOR_NAV_LIST_GROUP).forEach(function (
          listGroup
        ) {
          ...
          SelectorEngine.prev(listGroup, SELECTOR_NAV_ITEMS).forEach(function (
            navItem
          ) {
  ...
  var Tab = /*#__PURE__*/ (function (_BaseComponent) {
    ...
    _proto.show = function show() {
      ...
      var hideEvent = previous
        ? EventHandler.trigger(previous, EVENT_HIDE$3, {
            relatedTarget: this._element,
          })
        : null;
    ...
    _proto._activate = function _activate(element, container, callback) {
      ...
      var isTransitioning =
        callback && active && active.classList.contains(CLASS_NAME_FADE$4);
    ...
    _proto._transitionComplete = function _transitionComplete(
      ...
      if (
        ...
        if (dropdownElement) {
          SelectorEngine.find(SELECTOR_DROPDOWN_TOGGLE$1).forEach(function (
            dropdown
          ) {
